...
(function () {
  ...
  function resetForm() {
    ...
    const customBudgetField = $('#customBudgetField');
    if (customBudgetField) customBudgetField.style.display = 'none';
  }
  ...
  function initModal() {
    ...
    const customBudgetField = $('#customBudgetField');
    const customBudgetInput = $('#customBudgetInput');
    ...
    $$('.z-budget-card').forEach(card => {
      card.addEventListener('click', () => {
        ...
        if (card.dataset.value === 'custom') {
          if (customBudgetField) customBudgetField.style.display = 'block';
          formData.budget = customBudgetInput ? customBudgetInput.value.trim() : '';
          if (customBudgetInput) customBudgetInput.focus();
        } else {
          if (customBudgetField) customBudgetField.style.display = 'none';
    ...
    if (customBudgetInput) {
      customBudgetInput.addEventListener('input', () => {
        formData.budget = customBudgetInput.value.trim();
      });
    }
